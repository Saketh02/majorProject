...
from .views import TransportRequestAPI, paymentPageAPI, payFeePageAPI, paymentCaptureAPI, viewBusPassAPI, webhookAPI
...
urlpatterns = [
    ...
    path("bus-pass", viewBusPassAPI.as_view(), name="bus-pass")
]
