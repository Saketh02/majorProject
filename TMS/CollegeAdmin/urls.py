...
urlpatterns = [
    ...
    path("admin-reqs", views.viewAdminReqsAPI.as_view(), name="admin-reqs"),
    ...
    path("find-student", views.findStudentAPI.as_view(), name="find-student"),
    path(
        "submit-admin-reqs",
        views.acceptOrRejectAdminReqsAPI.as_view(),
        name="submit-admin-reqs",
    ),
]
